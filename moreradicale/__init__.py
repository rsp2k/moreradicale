...
from moreradicale import config, log, types, utils
from moreradicale.app import Application
from moreradicale.log import logger

VERSION: str = utils.package_version("moreradicale")
...
def _get_application_instance(config_path: str, wsgi_errors: types.ErrorStream
    ...
    if _application_config_path != config_path:
        raise ValueError("MORERADICALE_CONFIG must not change: %r != %r" %
...
def application(environ: types.WSGIEnviron,
    ...
    config_path = environ.get("MORERADICALE_CONFIG",
