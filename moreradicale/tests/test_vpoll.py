...
END:VCALENDAR"""
    ...
    def test_parse_vpoll_with_votes(self):
        ...
        from moreradicale.vpoll.component import parse_vpoll
...
END:VCALENDAR"""
    ...
    def test_vote_response_ranges(self):
        ...
        from moreradicale.vpoll.component import Vote
...
class TestVPollStatus:
    ...
    def test_status_values(self):
        ...
        from moreradicale.vpoll.component import VPollStatus
    ...
    def test_poll_mode_values(self):
        ...
        from moreradicale.vpoll.component import PollMode

        assert PollMode.BASIC.value == "BASIC"

    def test_poll_completion_values(self):
        """Test POLL-COMPLETION values."""
        from moreradicale.vpoll.component import PollCompletion
