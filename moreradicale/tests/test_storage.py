...
import moreradicale.tests.custom.storage_simple_sync
from moreradicale.tests import BaseTest
from moreradicale.tests.helpers import get_file_content
from moreradicale.tests.test_base import TestBaseRequests as _TestBaseRequests
...
class TestCustomStorageSystem(BaseTest):
    ...
    def setup_method(self) -> None:
        ...
        self.configure({"storage": {
            "type": "moreradicale.tests.custom.storage_simple_sync"}})
...
class TestCustomStorageSystemCallable(BaseTest):
    ...
    def setup_method(self) -> None:
        _TestBaseRequests.setup_method(cast(_TestBaseRequests, self))
        self.configure({"storage": {
            "type": moreradicale.tests.custom.storage_simple_sync.Storage}})
