...
This module can be executed from a command line with ``$python -m moreradicale``.
...
from moreradicale import VERSION, config, log, server, storage, types
...
def run() -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="moreradicale", usage="%(prog)s [OPTIONS]", allow_abbrev=False)
