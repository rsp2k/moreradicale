...
class TestWebSyncManager:
    ...
    def setup_method(self):
        ...
        from radicale.websync.manager import websync_manager
        websync_manager.reset()

    def test_singleton_pattern(self):
        """Test that WebSyncManager is a singleton."""
        from radicale.websync.manager import WebSyncManager
    ...
    def test_notify_subscribed_connections(self):
        ...
        from radicale.websync.manager import websync_manager, NotificationType
    ...
    def test_connection_is_subscribed(self):
        ...
        from radicale.websync.manager import WebSyncConnection
...
class TestChangeNotification:
    ...
    def test_notification_to_json(self):
        ...
        from radicale.websync.manager import ChangeNotification, NotificationType
...
class TestWebSocketFrame:
    ...
    def test_build_text_frame(self):
        ...
        from radicale.websync.handler import WebSocketFrame
...
class TestNotifyChangeFunction:
    ...
    def test_notify_change(self):
        ...
        from radicale.websync.manager import websync_manager
        from radicale.websync.handler import notify_change
