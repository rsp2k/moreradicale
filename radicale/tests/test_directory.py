...
class TestVCardBuilder:
    ...
    def test_build_minimal_vcard(self):
        ...
        from radicale.directory.vcard_mapper import VCardBuilder
...
class TestVCardMapper:
    ...
    def test_map_basic_entry(self):
        ...
        from radicale.directory.vcard_mapper import VCardMapper
...
class TestDefaultMapping:
    ...
    def test_default_mapping_contains_common_attrs(self):
        ...
        from radicale.directory.vcard_mapper import DEFAULT_LDAP_MAPPING
...
class TestVCardEscaping:
    ...
    def test_escape_empty_string(self):
        ...
        from radicale.directory.vcard_mapper import _escape_vcard
